...
## Unreleased
- Vehicle model: added low-poly parametric mesh aligned to footprint dimensions.
- Top/Side editing: added toggle to enable 2D projection dragging (XY for Top, XZ for Side).
- Scenario overlays: pedestrian crossing and intersection paths with coverage indicators.
